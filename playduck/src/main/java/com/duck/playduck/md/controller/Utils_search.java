...
public class Utils_search {
	...
	public static String getPageBar(int totalContents, int cPage, int numPerPage, String url, String keyword ){
		...
		if(pageNo == 1 ){
			...
			pageBar += "<a class='page-link' href='javascript:fn_paging("+(pageNo-1)+", \""+keyword +"\")'>&laquo; 이전</a>";
			pageBar += "</li>";
		}
		...
		while(!(pageNo>pageEnd || pageNo > totalPage)){
			if(cPage == pageNo ){
				...
				pageBar += "<li class='page-item'>";
				pageBar += "<a class='page-link' href='javascript:fn_paging("+pageNo+", \""+keyword +"\")'>"+pageNo+"</a>";
				pageBar += "</li>";
			}
			pageNo++;
		}
		...
		if(pageNo > totalPage){
			...
			pageBar += "<li class='page-item'>";
			pageBar += "<a class='page-link' href='javascript:fn_paging("+pageNo+", \""+keyword+"\")'>다음 &raquo;</a> ";
			pageBar += "</li>";
		}
