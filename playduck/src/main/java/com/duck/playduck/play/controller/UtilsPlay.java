	...
	//페이지 계산 처리 및 HTML 생성용 클래스
		...
		public static String getPageBar(int totalContents, int cPage, int numPerPage, int sortType, String url ){
			...
			if(pageNo == 1 ){
				...
				pageBar += "<a class='page-link' href='javascript:fn_paging("+(pageNo-1)+", \"" + sortType + "\")'>이전</a>";
				pageBar += "</li>";
			}
			...
			while(!(pageNo>pageEnd || pageNo > totalPage)){
				if(cPage == pageNo ){
					...
					pageBar += "<li class='page-item'>";
					pageBar += "<a class='page-link' href='javascript:fn_paging("+pageNo+", \"" + sortType + "\")'>"+pageNo+"</a>";
					pageBar += "</li>";
				}
				pageNo++;
			}
			...
			if(pageNo > totalPage){
				...
				pageBar += "<li class='page-item'>";
				pageBar += "<a class='page-link' href='javascript:fn_paging("+pageNo+", \"" + sortType + "\")'>다음</a> ";
				pageBar += "</li>";
			}
			...
			//2.스크립트 태그 작성
					//fn_paging함수
					pageBar += "<script>";
					pageBar += "function fn_paging(cPage,sortType,numPerPage){";
